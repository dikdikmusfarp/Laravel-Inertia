...
<template>
    <div class="grid relative" v-for="item in items" :key="item.id">
        <Link :href="route('item.show', item.id)" class="inset-0 absolute z-10">
        </Link>
        ...
        <div class="font-semibold text-[22px] text-[#FEFCFD] mt-6">{{ item.name }}</div>
